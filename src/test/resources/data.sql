...
INSERT INTO `tbl_city` (`city_id`, `code`, `city_kana`, `city`, `prefecture_id`) VALUES ('413134', '01102', 'ｻｯﾎﾟﾛｼｷﾀ', '札幌市北区', '2288');

INSERT INTO `tbl_city` (`city_id`, `code`, `city_kana`, `city`, `prefecture_id`) VALUES ('413135', '01103', 'ｱﾏｸﾞﾝｶﾆｴﾁｮｳupdate', '海部郡蟹江町update', '2288');
