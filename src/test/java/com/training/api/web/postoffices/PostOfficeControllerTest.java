...
public class PostOfficeControllerTest {
	...
	public void testSearchAddressByPrefectureCode() throws Exception {
		...
		when(postOfficeService.searchByPrefectureCode(anyString())).thenReturn(searchPrefectureCodeResponseList);
	...
	public void testSearchAddressByPrefectureCodeThrowIAE() throws Exception {
		// setup
		City city = CityFixtures.createCity();
		doThrow(IllegalArgumentException.class).when(postOfficeService).searchByPrefectureCode(anyString());
	...
	public void searchByPrefectureCodeThrowNFE() throws Exception {
		// setup
		City city = CityFixtures.createCity();
		doThrow(NotFoundException.class).when(postOfficeService).searchByPrefectureCode(anyString());
	...
	public void testSearchAddressByPostCode() throws Exception {
		...
		when(postOfficeService.searchByPostCode(anyString())).thenReturn(responseList);
	...
	public void testSearchAddressByPostCodeThrowIAE() throws Exception {
		// setup
		Area tblArea = AreaFixtures.createArea();
		doThrow(IllegalArgumentException.class).when(postOfficeService).searchByPostCode(anyString());
	...
	public void testSearchAddressByPostCodeThrowNFE() throws Exception {
		// setup
		Area tblArea = AreaFixtures.createArea();
		doThrow(NotFoundException.class).when(postOfficeService).searchByPostCode(anyString());
